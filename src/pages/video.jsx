    ...
    <ContentContainer>
      ...
      <GameUI>
        ...
        <div className={video['video-container']}>
          ...
          <div>
            <Link href={returnPreviousGame()}><a><img src={arrowLeft} alt="arrow-left" /></a></Link><a className={video.link} href='https://english-4-kids.vercel.app/pages/videos.html'>Mas videos</a><Link href={`/game/${link}`}><a><img src={arrowRight} alt="arrowRight" /></a></Link>
          </div>
        </div>
      </GameUI>
    </ContentContainer>
