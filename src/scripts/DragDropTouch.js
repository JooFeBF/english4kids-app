  ...
  var DragDropTouch = (function () {
    ...
    function DragDropTouch () {
      ...
      if ('ontouchstart' in document) {
        const d = document; const ts = this._touchstart.bind(this); const tm = this._touchmove.bind(this); const te = this._touchend.bind(this)
    ...
    DragDropTouch.prototype._getTarget = function (e) {
      const pt = this._getPoint(e); let el = document.elementFromPoint(pt.x, pt.y)
    ...
    DragDropTouch.prototype._createImage = function (e) {
      ...
      if (!this._imgCustom) {
        const rc = src.getBoundingClientRect(); const pt = this._getPoint(e)
    ...
    DragDropTouch.prototype._moveImage = function (e) {
      ...
      requestAnimationFrame(function () {
        const pt = _this._getPoint(e, true); const s = _this._img.style
        s.position = 'absolute'
    ...
    DragDropTouch.prototype._dispatchEvent = function (e, type, target) {
      if (e && target) {
        const evt = document.createEvent('Event'); const t = e.touches ? e.touches[0] : e
